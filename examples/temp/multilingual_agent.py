...
logger.info("Multilingual Agent starting up - logging configured successfully")
...
- **Supported Languages**: English + All 22 Indian scheduled languages (Hindi, Tamil, Telugu, Kannada, Malayalam, Marathi, Gujarati, Bengali, Punjabi, Odia, Assamese, Urdu, Konkani, Manipuri, Nepali, Bodo, Dogri, Maithili, Sanskrit, Santali, Sindhi)
- **No Language Switching**: Do NOT switch languages mid-conversation unless the user does
- **Language Consistency**: If user speaks in Hindi, respond in Hindi. If user speaks in Tamil, respond in Tamil. Maintain this throughout the conversation.
...
async def entrypoint(ctx: JobContext):
    ...
    # Initialize IndicParler-TTS using OpenAI Plugin
    # Supports all 23 Indian languages (22 scheduled + English)
    indic_tts = openai.TTS(
        base_url="http://localhost:8881/v1",
        model="ai4bharat/indic-parler-tts",
        # Voice description for natural, clear speech
        voice="A female speaker delivers a slightly expressive and animated speech with a moderate speed and pitch. The recording is of very high quality, with the speaker's voice sounding clear and very close up.",
        api_key="indic-tts",
    )
